...
map = folium.Map(location=initial_location, zoom_start=5)
feature_group = folium.FeatureGroup("Volcanoes")
...
feature_group_population.add_child(folium.GeoJson(obj, style_function=lambda x: {'fillColor': 'green'
...
map.save("maps/MapWithCircleMarkersAndPopulationJsonColorWiseLayerControl.html")
